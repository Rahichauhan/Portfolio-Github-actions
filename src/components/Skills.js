//The solar system model get from repeating radial gradient
...
<motion.div className='flex items-center justify-center rounded-full font-semibold bg-dark text-light py-3 px-6
    ...
    initial={{x:0,y:0}}
    //When the screen scrolls down to the skills it will automatically animate so
    //we use WhileInView instead of animate
...
const Skills = () => {
  return (
   <>
   <h2 className='font-bold text-8xl mt-64 w-full text-center md:text-6xl md:mt-32navbarnn'>Skills</h2>
   ...
   <motion.div className='flex items-center justify-center rounded-full font-semibold bg-dark text-light p-8
    ...
    <Skill name="OOPS" x="0vw" y="-20vw"/>
    <Skill name="MongoDB" x="-25vw" y="18vw"/>
    <Skill name="MVC" x="20vw" y="18vw"/>
