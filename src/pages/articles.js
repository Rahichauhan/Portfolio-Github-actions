...
import newImage from"../../public/images/articles/create modal component in react using react portals.png"
...
const MovingImg=({title,img,link})=>{
    ...
    return(
        ...
        style={{x:x,y:y}}
        initial={{opacity:0}}
        whileInView={{opacity:1,transition:{duration:0.2}}} ref={imageRef} src={img} alt={title} className=" z-10 w-96 h-auto hidden absolute rounded-lg
        md:!hidden "/></Link>
    )
}
...
const Article=({img,title,date,link})=>{
    return(
        ...
        bg-light dark:bg-dark text-dark dark:text-light first:mt-0 border border-solid border-dark border-r-4 border-b-4 dark:border-light">
...
const articles = () => {
  return (
    <>
      <Head>
        <title>Rahi Chauhan | Articles page</title>
        <meta
          name="description"
